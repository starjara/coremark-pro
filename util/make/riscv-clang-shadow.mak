...
CC		= $(TOOLS)/bin/clang -fsanitize=shadow-call-stack 
...
LD		= $(TOOLS)/bin/clang -static -Wl,--no-relax-gp,-T/home/jara/Desktop/riscv-mini/verselib/custom.x#,-flto
EXEOUT	= -o
EXE		= .riscv
