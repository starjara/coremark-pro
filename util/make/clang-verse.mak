...
TOOLS	= /home/rkdgkdud/project/riscv-tools
# For Solaris
#TOOLS	= /usr/local
# For Solaris
...
COMPILER_FLAGS	= -g -O2 $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -static -fsanitize=shadow-call-stack-verse
COMPILER_NOOPT	= -O0 -g $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -static
COMPILER_DEBUG	= -O0 -g $(CDEFN)HOST_EXAMPLE_CODE=1 -DBMDEBUG=1 -DTHDEBUG=1 -static
PACK_OPTS = 

#Variable: CFLAGS 
#	Options for the compiler.
ifdef DDB
 CFLAGS = $(COMPILER_DEBUG) $(COMPILER_DEFS) $(PLATFORM_DEFS) $(PACK_OPTS) -static
else
 ifdef DDN
  CFLAGS = $(COMPILER_NOOPT) $(COMPILER_DEFS) $(PLATFORM_DEFS) $(PACK_OPTS) -static
 else
  CFLAGS = $(COMPILER_FLAGS) $(COMPILER_DEFS) $(PLATFORM_DEFS) $(PACK_OPTS) -static
 endif
endif
ifdef DDT
 CFLAGS += -DTHDEBUG=1
...
LINKER_LAST 	+= -lm -lrt -lpthread -static -lverse -L/home/rkdgkdud/riscv-mini/verselib
endif
